...
struct symtable *newsym(char *name, int type, struct symtable *ctype,
  ...
  //For pointers and integer types, set the size of the symbol. structs and union declarations manually set this up themselves.
...
//Add an enum type or value to the enum list. Class is C_ENUMTYPE or C_ENUMVAL. Use posn to store the int value.
